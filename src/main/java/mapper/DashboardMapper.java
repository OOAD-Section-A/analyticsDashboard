...
public class DashboardMapper {
    ...
    public MarginResultDTO toMarginResultDTO(MarginResultInternal internal) {
        return new MarginResultDTO(
                internal.getMarginConceded(),
                internal.getMarginProtected(),
                internal.getPeriodStart(),
                internal.getPeriodEnd()
        );
    }
}
